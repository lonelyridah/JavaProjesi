...
public abstract class Kitap 
{
    ...
    public String ozellikleri_yazdir_arayuz(String veri_tipi , int kitabin_numarasi)
    {
        String veri ;
        ...
        veri = "\n\nKitabin Numarasi  : " + ( kitabin_numarasi + 1 ) + "\nKitabin Adi  : " + kitabin_adi + "\n" + "Yazar Adi    : " + yazarin_adi + "\n" + "Yayinevi     : " + yayin_evi + "\n" + "Sayfa Sayisi : " + Integer.toString(sayfa_sayisi) + "\n" + "Basim Yili   : " + Integer.toString(basim_yili) + "\n" + "ISBN         : " + ISBN_num + "\n" + "Fiyat        : " + Integer.toString(fiyat) + " TL" + "\nKitabin Turu  : " + veri_tipi  ;
